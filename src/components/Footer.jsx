    ...
    <footer className="footer" id="footer">
      <div className="container">
        <div className="footer__grid">
          <div className="footer__brand">
            <div className="footer__brand-row">
              <img src="/logo.png" alt="SabkaLoan" className="footer__logo" />
              <span className="footer__name">SabkaLoan</span>
            </div>
            <p className="footer__tagline">
              Compare. Apply. Get Funded.<br />
              India's trusted loan comparison platform.
            </p>
            ...
            <div className="footer__social">
              <a href="#" className="footer__social-link" aria-label="LinkedIn"><Link2 size={18} /></a>
              <a href="#" className="footer__social-link" aria-label="Website"><Globe size={18} /></a>
              <a href="#" className="footer__social-link" aria-label="More"><ExternalLink size={18} /></a>
            </div>
          </div>
          ...
          <div className="footer__col">
            ...
            <ul>
              <li className="footer__contact-item">
                <Mail size={14} />
                <a href="mailto:support@sabkaloan.com" className="footer__link">support@sabkaloan.com</a>
              </li>
              <li className="footer__contact-item">
                <Phone size={14} />
                <a href="tel:+911800123456" className="footer__link">1800-123-456 (Toll Free)</a>
              </li>
              <li className="footer__contact-item">
                <MapPin size={14} />
        ...
        <div className="footer__legal">
          ...
          <p className="footer__copy">© {new Date().getFullYear()} SabkaLoan. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
